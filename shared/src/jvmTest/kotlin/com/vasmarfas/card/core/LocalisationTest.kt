...
class LocalisationTest {
    ...
    // the search index is parsed out of the same XML by a Gradle task, not by the resource loader, so the
    // two decoders have to agree on every escape in every string
    @Test
