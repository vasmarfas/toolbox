...
val textCounterTool = Tool(
    ...
    description = Res.string.text_counter_description,
...
private fun TextCounterScreen() {
    ...
    ResultCard {
        KeyValueRow(Res.string.characters_count.str(), stats.chars.fmtGrouped(), copyable = false)
        ...
        KeyValueRow(Res.string.counter_sentences.str(), stats.sentences.fmtGrouped(), copyable = false)
        KeyValueRow(Res.string.counter_paragraphs.str(), stats.paragraphs.fmtGrouped(), copyable = false)
        KeyValueRow(Res.string.lines.str(), stats.lines.fmtGrouped(), copyable = false)
        KeyValueRow(Res.string.counter_utf_8_bytes.str(), stats.utf8Bytes.fmtGrouped(), copyable = false)
