...
object Filaments {
    val traits: Map<FilamentMaterial, FilamentTraits> = mapOf(
        ...
        FilamentMaterial.PC_ABS to FilamentTraits(ENGINEERING, 112, 3, 5, 2, 3, 3, 2, 2, 3, CLOSED, setOf(DRY, FUMES)),
        FilamentMaterial.PVDF to FilamentTraits(ENGINEERING, 158, 3, 3, 3, 2, 1, 5, 5, 5, CLOSED, setOf(OUTDOOR)),
        ...
        FilamentMaterial.PETG_CF_20 to FilamentTraits(FILLED, 71, 4, 2, 1, 4, 4, 3, 3, 3, NONE, setOf(OUTDOOR, ABRASIVE, DRY)),
        FilamentMaterial.PETG_GF_20 to FilamentTraits(FILLED, 70, 3, 2, 1, 4, 3, 3, 3, 3, NONE, setOf(OUTDOOR, ABRASIVE, DRY)),
        FilamentMaterial.ABS_CF_20 to FilamentTraits(FILLED, 102, 3, 4, 1, 3, 2, 2, 3, 3, CLOSED, setOf(ABRASIVE, FUMES)),
